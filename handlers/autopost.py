...
async def build_autopost_text(telegram_id: int) -> tuple[str, bool]:
    ...
    status = "работает" if user.autopost_enabled and active_ads and active_groups else "остановлен"
    ...
    text = (
        ...
        "Бот публикует объявления в группы с учётом интервалов, "
        "тихих часов и антибан-пауз для каждой барахолки."
    )
